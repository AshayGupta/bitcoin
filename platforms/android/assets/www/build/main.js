...
var TransactionPage = (function () {
    ...
    TransactionPage.prototype.plus_clicked = function (tran, selected) {
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, database) {
        ...
        platform.ready().then(function () {
            ...
            splashScreen.hide();
            database.createDatabase().then(function (data) {
...
var Database = (function () {
    ...
    Database.prototype.createDatabase = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.sqlite.create({ name: "bitcoin.db", location: "default" }).then(function (db) {
                _this.db = db;
                resolve('');
            }, function (error) {
    ...
    Database.prototype.alterTable = function () {
        this.db.executeSql("ALTER TABLE transaction_tbl ADD COLUMN trans_selected TEXT", []).catch(function (e) { return console.log("Column trans_selected is not altered. ", e); });
    };
    ...
    Database.prototype.insertTransactionData = function (transaction) {
        ...
        return new Promise(function (resolve, reject) {
            var transactionData = [
                ...
                _this.util.removeNull(transaction.trans_selected),
            ];
            var query = "INSERT INTO transaction_tbl (rate, amount, coins, action, date, trans_selected) VALUES (?,?,?,?,?,?)";
    ...
    Database.prototype.updateTransactionData = function (transaction) {
        var _this = this;
        var transactionData = [
        ...
        return new Promise(function (resolve, reject) {
            var updateQuery = "UPDATE transaction_tbl SET trans_selected=? WHERE id='" + transaction.id + "' ";
            _this.db.executeSql(updateQuery, transactionData).then(function (data) {
                resolve(data);
            }, function (error) {
